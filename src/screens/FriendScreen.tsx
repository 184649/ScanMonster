...
const styles = StyleSheet.create({
  ...
  worldTitle: { color: "#071B46", fontSize: 20, fontWeight: "900" },
  intro: { color: "#52627A", fontSize: 13, lineHeight: 20, fontWeight: "700" },
  qrCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
  ...
  qrTitle: { color: "#0F172A", fontSize: 18, fontWeight: "900" },
  qrText: { color: "#64748B", fontSize: 12, lineHeight: 18, fontWeight: "700" },
  ...
  btnHalf: { flex: 1 },
  sectionTitle: { color: "#071B46", fontSize: 16, fontWeight: "900", marginTop: 4 },
  emptyCard: { borderRadius: 12, padding: 18, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#EEF2F7" },
  emptyText: { color: "#64748B", fontSize: 13, fontWeight: "700", textAlign: "center", lineHeight: 19 }
});
